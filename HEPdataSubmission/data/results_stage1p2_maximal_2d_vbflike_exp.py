...
def make_table():
  ...
  xparam = 'r_ggH_VBFlike'
  yparam = 'r_qqH_VBFlike'
  ...
  fobs = "/afs/cern.ch/work/j/jlangfor/hgg/legacy/FinalFits/UL/Dec20/CMSSW_10_2_13/src/flashggFinalFit/Combine/runFits_UL_redo_stage1p2_maximal/output_profile2D_syst_fixedMH_r_ggH_VBFlike_vs_r_qqH_VBFlike.root"
  ...
  table = Table("STXS stage 1.2 maximal 2D: VBF-like (expected)")
  ...
  q = Variable("Expected -2$\\Delta$NLL", is_independent=False, is_binned=False)
  ...
  # Add figure
  #table.add_image("/afs/cern.ch/work/j/jlangfor/hgg/legacy/FinalFits/UL/Dec20/CMSSW_10_2_13/src/OtherScripts/HEPdata/hepdata_lib/hig-19-015/inputs/scan2D_r_ggH_VBFlike_vs_r_qqH_VBFlike_obs.pdf")
