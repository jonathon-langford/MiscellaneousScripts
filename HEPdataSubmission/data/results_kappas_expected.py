...
def make_table():
  ...
  fobs = "/afs/cern.ch/work/j/jlangfor/hgg/legacy/FinalFits/UL/Dec20/CMSSW_10_2_13/src/flashggFinalFit/Combine/runFits_UL_redo_kappas/output_scan2D_syst_fixedMH_kappa_g_vs_kappa_gam.root"
  ...
  table = Table("Kappas 2D: effective coupling modifiers (expected)")
