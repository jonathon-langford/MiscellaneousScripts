...
def make_table():
  ...
  fobs = "/afs/cern.ch/work/j/jlangfor/hgg/legacy/FinalFits/UL/Dec20/CMSSW_10_2_13/src/flashggFinalFit/Combine/runFits_UL_redo_stage1p2_maximal/output_profile2D_syst_fixedMH_r_ttH_vs_r_tH.root"
  ...
  table = Table("STXS stage 1.2 maximal 2D: top-associated (expected)")
  ...
  # Add figure
  #table.add_image("/afs/cern.ch/work/j/jlangfor/hgg/legacy/FinalFits/UL/Dec20/CMSSW_10_2_13/src/OtherScripts/HEPdata/hepdata_lib/hig-19-015/inputs/scan2D_r_tH_vs_r_ttH_obs.pdf")
