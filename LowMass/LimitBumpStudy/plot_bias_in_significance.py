...
axs[2].text(0.1, 0.2, sys.argv[4], transform=axs[2].transAxes, ha='left')

if not os.path.isdir(sys.argv[3]):
    os.makedirs(sys.argv[3], exist_ok=False)

ext_str = "" if sys.argv[4]=="" else f"_{sys.argv[4]}"
fig.savefig(sys.argv[3] + f"/bias_in_significance{ext_str}.png", bbox_inches='tight')
fig.savefig(sys.argv[3] + f"/bias_in_significance{ext_str}.pdf", bbox_inches='tight')
